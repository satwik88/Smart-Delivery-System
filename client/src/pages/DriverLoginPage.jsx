    ...
    <div className="min-h-screen bg-surface-bg flex items-center justify-center p-6 relative overflow-hidden text-text-main font-sans selection:bg-brand-blue selection:text-white transition-colors duration-300">
      ...
      >
        ...
        >
          <div className="flex flex-col items-center mb-10 text-center">
            <div className="w-16 h-16 bg-surface-bg rounded-2xl flex items-center justify-center mb-6 border border-border-main shadow-inner relative overflow-hidden group">
              ...
              <Truck className="text-brand-blue relative z-10" size={32} strokeWidth={1.5} />
            </div>
            <h2 className="text-2xl font-black tracking-tight mb-2">Driver Portal</h2>
            <p className="text-text-muted text-sm font-medium">Log in to view active delivery assignments and routes.</p>
          </div>

          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-text-muted uppercase tracking-wider mb-2">Driver Username</label>
            ...
            <div>
              ...
              <AnimatePresence>
                {error && (
                  ...
                  >
                    Authentication failed. Check credentials and driver access.
                  </motion.p>
                )}
              </AnimatePresence>
            </div>
        ...
        <p className="text-center text-xs font-bold text-text-muted mt-8">
          Powered by SLRROS Live-ops Engine
        </p>
      </motion.div>
    </div>
  );
