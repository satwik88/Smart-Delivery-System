...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F4F5FF] text-gray-900 font-sans selection:bg-brand-blue selection:text-white">
      ...
      <section className="pt-40 pb-20 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <motion.h1 variants={fadeIn} className="text-5xl lg:text-7xl font-black leading-[1.1] tracking-tight mb-6 text-gray-900">
              Enterprise Logistics, <br/><span className="text-brand-blue">Simplified.</span>
            </motion.h1>
            <motion.p variants={fadeIn} className="text-lg text-gray-500 mb-10 max-w-2xl mx-auto lg:mx-0 font-medium">
            ...
            <motion.div variants={fadeIn} className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              ...
              <Link to="/track" className="bg-white text-gray-900 border border-gray-200 px-8 py-4 rounded-full font-bold hover:border-gray-300 hover:bg-gray-50 transition-all w-full sm:w-auto text-center">
                Track a Package
              </Link>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 bg-white rounded-[3rem] shadow-2xl overflow-hidden border border-white/50 backdrop-blur-xl flex flex-col p-8">
               ...
               <div className="flex-1 bg-gray-50 rounded-2xl p-4 flex gap-4">
                 <div className="w-1/3 bg-white rounded-xl shadow-sm border border-gray-100 p-4 space-y-4">
                 ...
                 <div className="flex-1 flex flex-col gap-4">
                   <div className="flex gap-4">
                     <div className="flex-1 h-20 bg-white rounded-xl shadow-sm border border-gray-100 p-4">
      ...
      <section id="features" className="py-24 bg-white px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 font-medium max-w-2xl mx-auto">A complete suite of tools designed to optimize your supply chain from warehouse to doorstep.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center mb-6 shadow-sm">{f.icon}</div>
